...
export default class binarysearchtree extends React.Component {
    ...
    initialize() {
        ...
        let edge0 = new Edge(this.ref, "edge" + j, this.root.x-3 + "%", this.root.y+1.5 + "%", this.root.x - 18 + "%", this.root.y + 7 + "%", "visible");
        let edge1 = new Edge(this.ref, "edge" + j, this.root.x+3 + "%", this.root.y+1.5 + "%", this.root.x + 18 + "%", this.root.y + 7 + "%", "visible");
        // child of root node
        this.node1 = new Node(this.ref, null, 30, 20, 1);
        let edge3 = new Edge(this.ref, "edge" + j, this.node1.x-3 + "%", this.node1.y+1.5 + "%", this.node1.x - 12 + "%", this.node1.y + 25 + "%", "visible");
        let edge4 = new Edge(this.ref, "edge" + j, this.node1.x+3 + "%", this.node1.y+1.5 + "%", this.node1.x + 12 + "%", this.node1.y + 25 + "%", "visible");
        
        this.node2 = new Node(this.ref, null, 69, 20, 2);
        let edge5 = new Edge(this.ref, "edge" + j, this.node2.x-3 + "%", this.node2.y+1.5 + "%", this.node2.x - 10 + "%", this.node2.y + 20 + "%", "visible");
        let edge6 = new Edge(this.ref, "edge" + j, this.node2.x+3 + "%", this.node2.y+1.5 + "%", this.node2.x + 12 + "%", this.node2.y + 25 + "%", "visible");
        // child of child of root node left side
        this.node3 = new Node(this.ref, null, 20, 40, 4);
        this.node4 = new Node(this.ref, null, 40, 40, 5);
        // child of child of root node right side
        this.node5 = new Node(this.ref, null, 60, 40, 6);
        this.node6 = new Node(this.ref, null, 80, 40, 7);

        const number = 5;

        this.node2 = new Node(this.ref, number, 69, 20, 2);
